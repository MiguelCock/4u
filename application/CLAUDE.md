...
8. **`AdminHomeScreen`** — `GET /anchor-points` (`backend-map-management`), listed by description/status; a floating action button opens `CaptureScreen` and refreshes the list on return.
